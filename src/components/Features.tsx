...
export function FeaturesSectionDemo() {
  ...
  return (
    <div className="relative z-20 w-full">
      <div className="px-8">
        <h4 className="text-3xl lg:text-6xl lg:leading-tight max-w-5xl mx-auto text-center tracking-tight font-bold text-black dark:text-white">
          {"Church Life & Events"}
        </h4>
      ...
      <div className="relative ">
        <div className="grid grid-cols-1 lg:grid-cols-6 mt-12 xl:border rounded-md dark:border-neutral-800">
          {features.map((feature) => (
            <div className={cn("h-full w-full", feature.className)}>
              {feature.skeleton}
            </div>
          ))}
        </div>
...
export const SkeletonTwo = () => {
  ...
  return (
    <div className="relative flex flex-col items-start p-8 h-full overflow-hidden">
